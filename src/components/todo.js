              ...
              <li className='list-items'>
                <div className='list-item-list' id={to.status ? 'list-item' : ''}>{to.list}</div>
                  <span> 
                    ...
                    <AiTwotoneEdit className='list-item-icons' id='edit' title='Edit' onClick={()=>onEdit(to.id)}/>
                    <RiDeleteBinFill className='list-item-icons' id='delete' title='Delete' onClick={()=>onDelete(to.id)}/>
                  </span>
              </li>
            ))
          }
